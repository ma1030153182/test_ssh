...
<body>
	...
	<div role="navigation" id="foo" class="nav-collapse">
		<ul>
			...
			<li class="active"><a href="#">待审核的报名信息</a></li>
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>英语四级</td>
							<td><input id="<%=j++%>" type="button" value="审核通过"
								onclick="check(<%=list.get(i).getId()%>,1,<%=j - 1%>)" /></td>
						...
						<tr>
							...
							<td>英语六级</td>
							<td><input id="<%=j++%>" type="button" value="审核通过"
								onclick="check(<%=list.get(i).getId()%>,2,<%=j - 1%>)" /></td>
						...
						<tr>
							...
							<td>计算机考试</td>
							<td><input id="<%=j++%>" type="button" value="审核通过"
								onclick="check(<%=list.get(i).getId()%>,3,<%=j - 1%>)" /></td>
