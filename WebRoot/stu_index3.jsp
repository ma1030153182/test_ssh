...
<body>
	...
	<div role="navigation" id="foo" class="nav-collapse">
		<ul>
			...
			<li class="active"><a href="#">英语四级报名</a></li>
	...
	<div role="main" class="main">
		...
		<%
			int cet = 0;
			if (student.getCetf() == 1) {
		%>
		<font size="5"> 您的英语四级状态为“未报名”，可点击下方的报名按钮参与报名</font><br>
		<br> <font size="5"> 注：一旦参与报名，则不可撤销，请谨慎！！！！</font><br>
		<br>
		<span class="button-wrap">
           <a href="http://localhost:8080/test_ssh/student/cetf" class="button button-pill button-raised button-primary">报名参加英语四级考试</a>
        </span>
		<%
			}
			if(student.getCetf() == 2){%>
			<font size="5"> 您的英语四级状态为“已报名”，正在等待学院审核。。。</font><br>
			<%
			}
			
			if(student.getCetf() == 3){%> 
			<font size="5"> 您的英语四级状态为“已审核”，可以参加接下来的英语四级考试</font><br>
			<%
			}
			
			if(student.getCetf() == 4){%> 
			<font size="5"> 您的英语四级状态为“已通过”，具备英语六级报名资格</font><br>
			<%
			}
		%>
	</div>
